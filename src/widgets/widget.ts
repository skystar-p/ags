...
import { BindableProps, Binding, Connectable, Props } from "../service.js";
import { idle, interval } from "../utils.js";
import { type CtorProps, kebabify, registerGObject } from "../utils/gobject.js";
...
export class AgsWidget<Attr> extends Gtk.Widget implements Widget<Attr> {
  ...
  _init(
    config: BaseProps<this, Gtk.Widget.ConstructorProperties & { child?: Gtk.Widget }, Attr> = {},
    child?: Gtk.Widget,
  ) {
